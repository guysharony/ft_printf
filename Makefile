...
#    Updated: 2019/11/06 10:40:40 by gsharony         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= ft_printf.c \
			  ${DIR_1}ft_string.c ${DIR_1}ft_number.c ${DIR_1}ft_adress.c ${DIR_1}ft_len.c \
			  ${DIR_2}ft_flags.c ${DIR_2}dsp_number.c ${DIR_2}dsp_string.c ${DIR_2}dsp_number_utils.c ${DIR_2}dsp_pc.c \
