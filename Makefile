...
#    Updated: 2019/11/10 21:41:35 by guysharon        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= ft_printf.c \
			  ...
			  ${DIR_2}ft_flags.c ${DIR_2}dsp_number.c ${DIR_2}dsp_unsigned.c ${DIR_2}dsp_unsigned_utils.c ${DIR_2}dsp_adress.c ${DIR_2}dsp_string.c ${DIR_2}dsp_number_utils.c ${DIR_2}dsp_pc.c ${DIR_2}parser.c \
