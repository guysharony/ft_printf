...
#    Updated: 2019/11/11 08:31:46 by gsharony         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= ft_printf.c \
			  ${DIR_1}ft_strings.c ${DIR_1}ft_number.c ${DIR_1}ft_len.c \
			  ${DIR_2}ft_flags.c ${DIR_2}dsp_unsigned.c ${DIR_2}dsp_unsigned_utils.c ${DIR_2}dsp_adress.c ${DIR_2}dsp_adress_utils.c ${DIR_2}dsp_string.c ${DIR_2}dsp_string_utils.c ${DIR_2}dsp_number.c ${DIR_2}dsp_number_utils.c ${DIR_2}dsp_pc.c ${DIR_2}parser.c \
