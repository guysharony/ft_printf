...
#    Updated: 2019/11/09 13:50:48 by guysharon        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= ft_printf.c \
			  ...
			  ${DIR_2}ft_flags.c ${DIR_2}dsp_number.c ${DIR_2}dsp_unsigned.c ${DIR_2}dsp_adress.c ${DIR_2}dsp_string.c ${DIR_2}dsp_number_utils.c ${DIR_2}dsp_pc.c ${DIR_2}parser.c \
