...
void	ft_check(int a, int b)
{
	if (a != b)
	{
		printf("\n\033[1;31mprintf    : %d\033[0m\n", a);
		printf("\033[1;31mft_printf : %d\033[0m\n", b);
	}
	else
	{
		printf("\n\033[1;32mprintf    : %d\033[0m\n", a);
		printf("\033[1;32mft_printf : %d\033[0m\n", b);
	}
}
...
int		main(void) 
{
	...
	a = printf("|fin des TESTs qui servenr a rien\200 < negatif|\n");
	fflush(stdout);
	b = ft_printf("|fin des TESTs qui servenr a rien\200 < negatif|\n");
	ft_check(a, b);
	...
	printf("\033[0;36m======================= TEST\033[0m 1\n");
	a = printf("|ok %d , %d , %d , %d *** %u , %u, %u , %u|\n", 123, -500000000, 5000000000, -2147483648, 123, -500000000, 5000000000, -2147483648);
	fflush(stdout);
	b = ft_printf("|ok %d , %d , %d , %d *** %u , %u, %u , %u|\n", 123, -500000000, 5000000000, -2147483648, 123, -500000000, 5000000000, -2147483648);
	ft_check(a, b);

	printf("\033[0;36m======================= TEST\033[0m 2\n");
	a = printf("|ok %x , %x , %x , %x *** %X , %X, %X , %X|\n", 123, -500000000, 5000000000, -2147483648, 123, -500000000, 5000000000, -2147483648);
	fflush(stdout);
	b = ft_printf("|ok %x , %x , %x , %x *** %X , %X, %X , %X|\n", 123, -500000000, 5000000000, -2147483648, 123, -500000000, 5000000000, -2147483648);
	ft_check(a, b);
